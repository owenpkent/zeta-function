...
Handed forward (cheap): the CF-on-D-H probe (does Caratheodory-Fejer run on the D-H coefficient stream; read 2511.23257 in full first), the D-H twin as a Section-7 convergence-failure testbed at $\gamma \approx 85.7$, and the absorption-count numerical shadow.
