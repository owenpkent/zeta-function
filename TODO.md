...
- [ ] **Stress-test the M3 conjecture (P_comp = 0 geometrically)**: before building the full signature, attack the claim that absolute prismatic cohomology kills composite cross-terms. If it fails, M3's discriminator is the Euler-product assumption in disguise.
