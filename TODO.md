...
- [ ] **Frame-audit follow-ups (2026-07-17):** see [`docs/03_research/ccm_corridor_frame_audit.md`](docs/03_research/ccm_corridor_frame_audit.md) + LEARNINGS #163.
...
- [ ] **P10 rational-root floor: open the mathlib4 PR.** CLEAR-TO-PR since 2026-07-02 (#RR-1/#RR-2 machine-checked in full UFD generality); idle 15 days; every week of master drift raises the port cost.
