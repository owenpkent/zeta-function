#!/usr/bin/env bash
# Overnight sweep, second pass (2026-09-02b, after the besselk fallback): J2-J6 only; J1 e3l was already running under the fixed module, J7 and J8 completed in the first pass. re-run every experiment that used the Epstein
