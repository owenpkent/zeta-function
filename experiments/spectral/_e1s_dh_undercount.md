> SALVAGED 2026-08-26 from PR #7 (branch overnight-wave-172-173). SUPERSEDED AS MECHANISM by
> e1y/#175(ii)(v) (conditioning: the near-null ground state) and by #175(vi)(1) (the conservation
> law n_pos = N - #(purely imaginary pairs)); KEPT as context for the Euler positive control
> (`_e1s_dh_undercount_euler_control.md`). The entry numbers cited inside are the BRANCH's
> numbering. Recorded at LEARNINGS #210.
