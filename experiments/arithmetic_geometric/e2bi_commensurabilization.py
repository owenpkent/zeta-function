...
(gamma_1 = 14.13) one needs D <= 2.25, where the jitter bound is 0.25:
exactly the default Beurling fake's epsilon (e2ak). Full fidelity pushes
the structure above every fixed height. This is the Q-linear-independence
wall (#162, #172, #188) measured along the quantization axis; per the
