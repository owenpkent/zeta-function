...
| 2 | **Sign sequence** | Among the first 50 zeta zeros, `Q(ρ_k) < 0` for **exactly one** index, **k = 34**. A global pairing that sees the zeros fails *sporadically* even under RH. |
