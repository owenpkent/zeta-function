# Overnight sweep, third pass (2026-09-02c): J1-J6 under the census-based zeros() (clamped Newton, argument-principle windows); J7 and J8 landed in the first pass.
